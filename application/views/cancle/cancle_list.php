...
<div class="row">
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 margin-bottom-10">
		<button type="button" class="btn btn-sm btn-danger" onclick="deleteSelected()">ลบรายการที่เลือก</button>
	</div>
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive">
		<table class="table table-bordered dataTable" style="min-width:1150px;">
			<thead>
				<tr>
					<th style="width:50px;" class="middle text-center">
						<label>
				...
				<?php foreach($details as $rs) : ?>
					<tr id="row-<?php echo $rs->id; ?>">
						<td class="middle text-center">
							<label>
				        <input type="checkbox" class="ace check-item" value="<?php echo $rs->id; ?>">
				        <span class="lbl"></span>
				      </label>
						</td>
						...
						<td class="middle text-right">
							<button type="button" class="btn btn-mini btn-danger" onclick="getDelete(<?php echo $rs->id; ?>, '<?php echo $rs->ItemCode; ?>')"><i class="fa fa-trash"></i></button>
						</td>
					</tr>
					<?php $no++; ?>
				<?php endforeach; ?>
...
<script src="<?php echo base_url(); ?>scripts/cancle/cancle.js?v=<?php echo date('YmdH'); ?>"></script>
