...
<form class="form-horizontal">
  <div class="form-group">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<input type="text" class="form-control input-sm" id="district" maxlength="100" autofocus />
    </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<input type="text" class="form-control input-sm" id="province" maxlength="100" />
    </div>
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<input type="text" class="form-control input-sm input-medium" id="zipCode" maxlength="10" />
    </div>
