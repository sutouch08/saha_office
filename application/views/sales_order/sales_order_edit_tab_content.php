      ...
      <table class="table table-bordered tableFixHead" style="min-width:2620px;">
        <thead>
          <tr class="font-size-10">
            ...
            <th class="fix-width-40 text-center fix-check fix-header"></th>
            <th class="fix-width-40 text-center fix-add fix-header"></th>
            <th class="fix-width-80 text-center fix-type fix-header">Type</th>
            <th class="fix-width-200 text-center fix-item fix-header">Item Code</th>
            <th class="fix-width-250 text-center">Item Description.</th>
            <th class="fix-width-200 text-center">Item Detail</th>
            <th class="fix-width-150 text-center">รหัสสมบูรณ์</th>
            <th class="fix-width-100 text-center">Quantity</th>
            <th class="fix-width-100 text-center">Uom</th>
            <th class="fix-width-100 text-center">STD Price</th>
            <th class="fix-width-100 text-center">Last Sell Price</th>
            <th class="fix-width-100 text-center">Price(exc.)</th>
            <th class="fix-width-100 text-center">Price(inc.)</th>
            <th class="fix-width-100 text-center">ส่วนต่างราคา(%)</th>
            <th class="fix-width-100 text-center">ส่วนลด(%)</th>
            <th class="fix-width-100 text-center">Tax Code</th>
            <th class="fix-width-100 text-center">มูค่า/หน่วย หลังส่วนลด(ก่อน vat)</th>
            <th class="fix-width-100 text-center">มูลค่ารวม (ก่อน vat)</th>
            <th class="fix-width-100 text-center">GP Margin(%)</th>
            <th class="fix-width-120 text-center">Whs</th>
            <th class="fix-width-100 text-center">In Stock</th>
            <th class="fix-width-100 text-center">Commited</th>
        ...
        <tbody id="details-template">
          ...
          <?php   foreach($details as $ds) : ?>
            ...
            <tr id="row-<?php echo $no; ?>">
              ...
              <td class="">
                <input type="text" class="form-control input-xs text-right number input-price_inc" id="price_inc-<?php echo $no; ?>" value="" onkeyup="changePrice($(this))"/>
              </td>
              <td class="">
          ...
          <tr id="row-<?php echo $no; ?>">
            ...
            <td class="">
              <input type="text" class="form-control input-xs text-right number" id="lstPrice-<?php echo $no; ?>" value="" readonly disabled/>
