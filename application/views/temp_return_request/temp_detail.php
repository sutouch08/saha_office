...
<div class="row">
  ...
  <div class="col-lg-1 col-md-1-harf col-sm-2 col-xs-3 padding-5">
	...
	<div class="col-lg-6 col-md-5 col-sm-12 col-xs-12 padding-5">
    ...
    <table class="table table-striped border-1" style="min-width:920px;">
      <thead>
        <tr class="font-size-11">
          ...
          <th class="fix-width-60">BaseType</th>
          <th class="fix-width-80">BaseRef</th>
        ...
        <?php if(!empty($details)) : ?>
          ...
          <?php foreach($details as $rs) : ?>
            <tr class="font-size-11">
              ...
              <td class="middle"><?php echo $rs->BaseType == 13 ? 'IV' : ($rs->BaseType == 15 ? 'DO' : ""); ?></td>
