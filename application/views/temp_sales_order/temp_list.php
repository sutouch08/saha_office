...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding-5 table-responsive">
    <table class="table table-striped border-1" style="min-width:1530px;">
      <thead>
        <tr class="font-size-11">
          ...
          <th class="fix-width-150">SAP date</th>
					<th class="min-width-300">Message</th>
        </tr>
      </thead>
      <tbody>
<?php if(!empty($orders))  : ?>
...
<script src="<?php echo base_url(); ?>scripts/temp/temp_sales_order.js?v=<?php echo date('Ymd'); ?>"></script>
