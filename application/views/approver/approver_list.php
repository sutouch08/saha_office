...
<div class="row">
    ...
    <div class="col-sm-6 col-xs-6 padding-5">
      ...
      <?php if($this->isAdmin OR $this->isSuperAdmin) : ?>
        <button type="button" class="btn btn-sm btn-success" onclick="goAdd()"><i class="fa fa-plus"></i> New Approval</button>
      <?php endif; ?>
      </p>
    </div>
</div><!-- End Row -->
...
<div class="row">
  <div class="col-sm-1 col-1-harf col-xs-6 padding-5">
    ...
    <input type="text" class="form-control input-sm text-center search-box" name="emp_name" value="<?php echo $name; ?>" />
  </div>
...
<?php $sort_gp = get_sort('min_gp', $order_by, $sort_by); ?>
		...
		<table class="table table-striped table-hover table-bordered dataTable">
			<thead>
				<tr>
					...
					<th class="width-30 middle sorting <?php echo $sort_name; ?>" id="sort_name" onclick="sort('name')">Employee</th>
					<th class="width-20 middle sorting <?php echo $sort_sale_team; ?>" id="sort_sale_team" onclick="sort('sale_team')">Sales Team</th>
					<th class="width-10 middle text-center sorting <?php echo $sort_gp; ?>" id="sort_min_gp" onclick="sort('min_gp')">Max gp</th>
			...
			<?php if(!empty($data)) : ?>
				...
				<?php foreach($data as $rs) : ?>
					<tr>
						...
						<td class="middle text-center"><?php echo $rs->max_discount .' %'; ?></td>
