...
<div class="row">
	...
	<div class="col-lg-2 col-md-3 col-sm-3 col-xs-6 padding-5">
		...
		<input type="text" id="NumAtCard" class="width-100" maxlength="100" value="<?php echo $doc->NumAtCard; ?>" disabled>
	</div>
				...
				<?php if (! empty($details)) : ?>
					...
					<?php foreach ($details as $rs) : ?>
						<tr class="font-size-11 return-rows">
							...
							<td class="middle text-center" title="Without Qty Posting"><?php echo $rs->NoInvtryMv; ?></td>
							<td class="middle">
	...
	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 padding-5">
		<div class="form-horizontal">
			<div class="form-group" style="margin-bottom:5px;">
				<label class="col-lg-2 col-md-2 col-sm-3 control-label no-padding-right">Owner</label>
			...
			<div class="form-group" style="margin-bottom:5px;">
				<label class="col-lg-2 col-md-2 col-sm-3 control-label no-padding-right">Status</label>
				<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
					<input type="text" class="form-control input-sm" value="<?php echo return_status_label($doc->status); ?>" disabled />
				</div>
			</div>
			<div class="form-group" style="margin-bottom:5px;">
				<label class="col-lg-2 col-md-2 col-sm-3 control-label no-padding-right">SAP No.</label>
				<div class="col-lg-5 col-md-6 col-sm-6 col-xs-12">
