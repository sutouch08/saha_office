				...
				<?php if (! empty($details)) : ?>
					...
					<?php foreach ($details as $rs) : ?>
						...
						<tr id="row-<?php echo $uid; ?>" class="return-rows">
							...
							<td class="middle text-center no" id="no-<?php echo $uid; ?>" data-uid="<?php echo $uid; ?>" onclick="toggleCheck('<?php echo $uid; ?>')"><?php echo $no; ?></td>
							<td class="middle">
								...
								<input type="checkbox" class="ace chk hide" id="chk-<?php echo $uid; ?>" value="<?php echo $uid; ?>" />
							</td>
							<td class="middle">
	...
	{{#each this}}
		<tr id="row-{{uid}}" class="return-rows">
			...
			<td class="middle">
				...
				<input type="checkbox" class="ace chk hide" id="chk-{{uid}}" value="{{uid}}" />
			</td>
			<td class="middle">
