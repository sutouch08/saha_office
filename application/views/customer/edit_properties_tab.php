            ...
            <tr>
              ...
              <td class="middle text-center">
                <label>
                  <input type="checkbox"
                  class="ace props"
                  data-label="QryGroup<?php echo $rs->code; ?>"
                  name="qryGroup[<?php echo $rs->code; ?>]"
                  id="qryGroup-<?php echo $rs->code; ?>" <?php echo is_checked('Y', $data->$label); ?>
                   />
                  <span class="lbl"></span>
                </label>
              </td>
