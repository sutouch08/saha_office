...
<form class="form-horizontal">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<input type="text" name="code" id="code" class="form-control input-sm code" max-length="20" value="" onkeyup="validCode(this)" autofocus required />
    </div>
  ...
  <div class="form-group">
    ...
    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			<input type="text" name="name" id="name" class="form-control input-sm" max-length="100" value="" required />
    </div>
