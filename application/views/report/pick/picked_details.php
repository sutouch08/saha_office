...
<div class="row">
  <div class="col-lg-2 col-md-2-harf col-sm-3 col-xs-12 padding-5">
	...
	<div class="col-lg-3 col-md-3-harf col-sm-4 col-xs-12 padding-5">
      ...
      <button type="button" class="btn btn-sm width-33" id="btn-doc-date" onclick="toggleSelectDate('DocDate')">PL Date</button>
...
<script id="template" type="text/x-handlebars-template">
  <table class="table table-bordered" style="width:100%; min-width:1440px; table-layout:fixed;">
    <tr class="font-size-12">
      <th class="fix-width-40 text-center">#</th>
      <th class="fix-width-100 text-center">PL NO.</th>
      ...
      <th class="fix-width-100 text-center">Release Qty</th>
      <th class="fix-width-100 text-center">Picked Qty</th>
      <th class="fix-width-100 text-center">Posting Date</th>
      <th class="fix-width-100 text-center">PL Date</th>
      <th class="fix-width-100 text-center">Start Pick</th>
      <th class="fix-width-100 text-center">Finish Pick</th>
...
{{#each data}}
    <tr class="font-size-12">
      ...
      <td class="middle text-center">{{ReleaseQty}}</td>
      <td class="middle text-center">{{PickQty}}</td>
      <td class="middle text-center">{{OrderDate}}</td>
      <td class="middle text-center">{{DocDate}}</td>
      <td class="middle text-center">{{StartPick}}</td>
      <td class="middle text-center">{{FinishPick}}</td>
...
<script src="<?php echo base_url(); ?>scripts/report/picked_details.js?v=<?php echo date('YmdH'); ?>"></script>
