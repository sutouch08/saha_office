<?php
class Pick_details_model extends CI_Model
{
  /* tables
  ** pick_list => OPKL
  ** pick_row => PKL1
  ...
  */
  ...
  public function get_list(array $ds = array(), $perpage = 20, $offset = 0)
  {
    ...
    $rs = $this->db->order_by($order_by, $sort_by)->limit($perpage, $offset)->get('picking_detail');
  ...
  public function count_rows(array $ds = array())
  {
    ...
    return $this->db->count_all_results('picking_detail');
  }
