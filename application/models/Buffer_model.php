...
class Buffer_model extends CI_Model
{
  ...
  */
  ...
  public function get_details($docNum)
  {
    $rs = $this->db->where('DocNum', $docNum)->get('buffer');
  ...
  public function get_list(array $ds = array(), $perpage = 20, $offset = 0)
  {
    ...
    $rs = $this->db->order_by($order_by, $sort_by)->limit($perpage, $offset)->get('buffer');
  ...
  public function count_rows(array $ds = array())
  {
    ...
    return $this->db->count_all_results('buffer');
  }
